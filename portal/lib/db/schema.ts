...
CREATE TABLE IF NOT EXISTS member_memberships (
  ...
  fee_type VARCHAR(50) NOT NULL CHECK (fee_type IN ('annual_membership', 'lifetime_membership', 'welfare_contribution')),
  plan VARCHAR(20) NOT NULL CHECK (plan IN ('annual', 'lifetime', 'welfare')),
